...
BROKER_MQTT = "4.236.177.132"
BROKER_PORT = 1883
TOPICO_LUMINOSITY = "/TEF/vin001/attrs/l"
TOPICO_TEMPERATURE = "/TEF/vin001/attrs/t"
TOPICO_HUMIDITY = "/TEF/vin001/attrs/h"
DASH_HOST = "127.0.0.1"  # Para rodar localmente

# Variáveis para armazenar dados recebidos do ESP32
luminosity_values = []
temperature_values = []
humidity_values = []
timestamps = []
...
# Callback para atualizar o gráfico combinado
@app.callback(
...
# Inicializa o servidor Dash e o loop MQTT
